namespace EncuestaEstudiantil
{
    internal class EncuestaEstudiantil
    {
        public static void Main(string[] args)
        {
            ...
            /*para cada respuesta, selecciona el elemento de respuestas y usa ese valor como subindice de frecuencia para determinar el elemento a incrementar */
